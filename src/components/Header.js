  ...
  return (
    ...
    <div className="header-container">
      <div className="header-menu">
        ...
        <Link
          to="/contact"
          className={location.pathname === "/contact" && "header-menu-clicked"}
        >
          Contact
        </Link>
        <Link
...
{/* Mobile Header */}
<div className="mobile-header-container"><GiHamburgerMenu className="burger-menu-button" onClick={()=>setBurgerHandle(true)}/>{burgerHandle && <div className="burger-menu" data-aos="slide-right">
<BiLeftArrowAlt className="burger-arrow" onClick={()=>setBurgerHandle(false)}/><Link
          to="/"
          className={location.pathname === "/" && "header-menu-clicked"}
        >
          Home
